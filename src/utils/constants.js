...
export const MOVIES_CARD_IMG_CDN_URL = "https://image.tmdb.org/t/p/w500";

export const SUPPORTED_LANGUAGES = [
  { id: 1, identifier: "english", name: "English" },
...
export const API_OPTIONS = {
  ...
  headers: {
    ...
    Authorization:
      `Bearer ${process.env.REACT_APP_TMDB_API_OPTIONS_TOKEN}`,
  },
};
